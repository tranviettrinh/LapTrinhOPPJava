...
public class GiangVien87 {
    ...
    public GiangVien87(String id, String name, String branch) {
        this.id = id;
        this.name = name;
        this.branch = branch;
    }
    ...
    public static void main(String[] args) {
        ...
        while (b++ < a) {
            String c = p.nextLine();
            String d = XuLyChu(c);
            System.out.println("DANH SACH GIANG VIEN BO MON " + d + ":");
            for (int i = 0; i < list.size(); i++) {

                if (list.get(i).getBranch().equalsIgnoreCase(d)) {
